...
public class CustomChartServiceFetchDetailsImpl extends AbstractHostInquiryTran {
	...
	protected void processHostData(FEBATransactionContext objTxnContext, IFEBAValueObject objInputOutput,
		...
		CustomChartEnquiryVO customChartEnquiryVO = (CustomChartEnquiryVO) objInputOutput;
       	...
       	EBHostInvoker.processRequest(objTxnContext, CustomEBRequestConstants.CUSTOM_CHART_INCOME_REQUEST, customChartEnquiryVO);
      	EBHostInvoker.processRequest(objTxnContext, CustomEBRequestConstants.CUSTOM_CHART_EXPENSE_REQUEST, customChartEnquiryVO);
